require(['html-react-parser', 'semver', 'bowser', 'react', 'react-dom', 'libraries/mediaelement-and-player', 'libraries/rangeslider', 'handlebars', 'libraries/SCORM_API_wrapper', 'underscore'], function (HTMLReactParser, semver, Bowser, React, ReactDOM$1, mediaelementAndPlayer, rangeslider, Handlebars$1, pipwerks, _$1) { 'use strict';
  ...
  var AccordionView = function (_ComponentView) {
    ...
    _createClass(AccordionView, [{
      ...
      value: function postRender() {
        ...
        (_this$getItemElement = this.getItemElement(this.model.getActiveItem())) === null || _this$getItemElement === void 0 ? void 0 : (_this$getItemElement$ = _this$getItemElement.find('.accordion__item-content')) === null || _this$getItemElement$ === void 0 ? void 0 : _this$getItemElement$.css('display', 'block');
        this.setReadyStatus();
  ...
  var QuestionModel = function (_ComponentModel) {
    ...
    _createClass(QuestionModel, [{
      ...
      value: function updateAttempts() {
        ...
        var attemptsLeft = (_this$get = this.get('_attemptsLeft')) !== null && _this$get !== void 0 ? _this$get : this.get('_attempts');
      ...
      value: function setUpDropdowns() {
        ...
        this.$('.matching__item').each(function (i, el) {
          ...
          var dropdown = new DropDown$1({
            ...
            value: (selectedOption === null || selectedOption === void 0 ? void 0 : selectedOption._index) || null
          });
  ...
  __AMD("components/adapt-contrib-mcq/js/adapt-contrib-mcq", Adapt.register('mcq', {
    model: McqModel,
    view: McqView$1
  }));
  ...
  var NarrativeView = function (_ComponentView) {
    ...
    _createClass(NarrativeView, [{
      ...
      value: function isTextBelowImage() {
        var isTextBelowImage = Adapt.device.screenSize === 'large' ? this.model.get('_isTextBelowImage') : this.model.get('_isMobileTextBelowImage');
  ...
  var BlockSliderView = {
    ...
    _blockSliderConfigureVariables: function () {
      var blocks = this.model.getChildren().models.filter(function (model) {
    ...
    _blockSliderShowAll: function () {
      ...
      this.model.getChildren().models.filter(function (model) {
        return model.isTypeGroup('block');
    ...
    _onBlockSliderPageScrollTo: function (selector) {
      ...
      if (_typeof(selector) === "object") selector = selector.selector;
      ...
      this.model.getChildren().models.filter(function (model) {
        ...
        _.defer(function () {
          return _this._blockSliderMoveIndex(index, false);
        });
  ...
  var AssessmentModel = {
    ...
    _setupAssessmentData: function (force, callback) {
      ...
      if (shouldResetAssessment || shouldResetQuestions) {
        this._resetQuestions(function () {
          _this.set('_attemptInProgress', true);

          Adapt.trigger('assessments:reset', _this.getState(), _this);
          finalise.apply(_this);
        });
      } else {
        finalise.apply(this);
      }
    ...
    _onBlockCompleted: function (blockModel, value) {
      ...
      questionModels.forEach(function (questionModel) {
        _this2._onQuestionCompleted(questionModel, value);
      });
    ...
    _onAssessmentComplete: function () {
      ...
      if (this._isMarkingSuppressionEnabled() && !this._isAttemptsLeft()) {
        _.defer(function () {
          _this3._overrideMarkingSettings();

          _this3._refreshQuestions();
        });
      }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return Adapt.navigateToElement(_this4.get('_id'));
    ...
    reset: function (force, callback) {
      ...
      if (this._isResetInProgress) {
        this.once('reset', function () {
          _this5._isResetInProgress = false;
  ...
  var LanguagePickerDrawerView = __AMD("extensions/adapt-contrib-languagePicker/js/languagePickerDrawerView", function (_Backbone$View) {
    ...
    _createClass(LanguagePickerDrawerView, [{
      ...
      value: function onDontChangeLanguage() {
        ...
        _.delay(function () {
          return Adapt.a11y.focusFirst(_this2.$finishFocus);
        }, 500);
      }
    }, {
      key: "getPromptObject",
  ...
  var TrickleController = function (_Backbone$Controller) {
    ...
    _createClass(TrickleController, [{
      ...
      get: function () {
        ...
        return Boolean((_Adapt$parentView = Adapt.parentView) === null || _Adapt$parentView === void 0 ? void 0 : _Adapt$parentView.model.get('_isTrickleStarted'));
      },
      set: function (value) {
  ...
  register("accordion", function Accordion(props) {
    ...
    return React__default['default'].createElement("div", {
      ...
      return React__default['default'].createElement("div", {
        className: classes(['accordion__item', _graphic.src && 'has-image', _classes]),
        key: _index,
        "data-index": _index
      }, React__default['default'].createElement("button", {
        id: "".concat(_id, "-").concat(index, "-accordion-button"),
        className: classes(['accordion__item-btn', 'js-toggle-item', _isVisited && 'is-visited', _isActive ? 'is-open is-selected' : 'is-closed']),
        onClick: onClick,
        "aria-expanded": _isActive.toString()
      }, React__default['default'].createElement("div", {
        className: "accordion__item-btn-inner"
      }, React__default['default'].createElement("div", {
        ...
        className: "accordion__item-title-inner"
      }, html(compile(title)))))), React__default['default'].createElement("div", {
        className: "accordion__item-content",
        role: "region",
        "aria-labelledby": "".concat(_id, "-").concat(index, "-accordion-button")
      }, React__default['default'].createElement("div", {
        className: "accordion__item-content-inner"
      }, body && React__default['default'].createElement("div", {
        className: "accordion__item-body"
      }, React__default['default'].createElement("div", {
        className: "accordion__item-body-inner"
  ...
  register("gmcq", function Gmcq(props) {
    ...
    return React__default['default'].createElement("div", {
      ...
      return React__default['default'].createElement("div", {
        className: classes(["gmcq__item item-".concat(index), shouldShowMarking && _shouldBeSelected ? 'is-correct' : null, shouldShowMarking && !_shouldBeSelected ? 'is-incorrect' : null]),
  ...
  register("mcq", function Mcq(props) {
    ...
    return React__default['default'].createElement("div", {
      ...
      return React__default['default'].createElement("div", {
        className: classes(["mcq__item item-".concat(index), shouldShowMarking && _shouldBeSelected && 'is-correct', shouldShowMarking && !_shouldBeSelected && 'is-incorrect']),
        key: _index
      }, React__default['default'].createElement("input", {
        ...
        type: _isRadio ? 'radio' : 'checkbox',
        disabled: !_isEnabled,
        "aria-label": !shouldShowMarking ? Adapt.a11y.normalize(text) : "".concat(_shouldBeSelected ? ariaLabels.correct : ariaLabels.incorrect, ", ").concat(_isActive ? ariaLabels.selectedAnswer : ariaLabels.unselectedAnswer, ". ").concat(Adapt.a11y.normalize(text)),
        "data-adapt-index": _index,
        onKeyPress: onKeyPress,
        onChange: onItemSelect,
        onFocus: onItemFocus,
        ...
        className: classes(['mcq__item-label', !_isEnabled && 'is-disabled', _isHighlighted && 'is-highlighted', (_isCorrectAnswerShown ? _shouldBeSelected : _isActive) && 'is-selected']),
        "aria-hidden": true,
        htmlFor: "".concat(_id, "-").concat(index, "-input"),
        "data-adapt-index": _index
      }, React__default['default'].createElement("div", {
        className: "mcq__item-state"
      }, React__default['default'].createElement("div", {
        className: classes(['mcq__item-icon', 'mcq__item-answer-icon', _isRadio ? 'is-radio' : 'is-checkbox'])
      }, React__default['default'].createElement("div", {
        className: "icon"
      })), React__default['default'].createElement("div", {
        className: "mcq__item-icon mcq__item-correct-icon"
      }, React__default['default'].createElement("div", {
        className: "icon"
      })), React__default['default'].createElement("div", {
        className: "mcq__item-icon mcq__item-incorrect-icon"
      }, React__default['default'].createElement("div", {
        className: "icon"
      }))), React__default['default'].createElement("div", {
        className: "mcq__item-text"
      }, React__default['default'].createElement("div", {
        className: "mcq__item-text-inner"
      }, html(compile(text))))));
    })), React__default['default'].createElement("div", {
      className: "btn__container"
    }));
